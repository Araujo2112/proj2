...
(
    ...
    valor_mensal_condominio numeric(10, 2),
    valor_anual_despesas numeric(10, 2),
...
ALTER TABLE IF EXISTS public.depositoprazo
    ADD CONSTRAINT depositoprazo_ativo_id_fkey FOREIGN KEY (ativo_id)
...
ALTER TABLE IF EXISTS public.fundoinvestimento
    ADD CONSTRAINT fundoinvestimento_ativo_id_fkey FOREIGN KEY (ativo_id)
    REFERENCES public.ativofinanceiro (id) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE CASCADE;
...
ALTER TABLE IF EXISTS public.imovelarrendado
    ADD CONSTRAINT imovelarrendado_ativo_id_fkey FOREIGN KEY (ativo_id)
    REFERENCES public.ativofinanceiro (id) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE CASCADE;
